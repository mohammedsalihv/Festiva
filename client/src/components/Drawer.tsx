...
const Drawer = ({ isOpen, onClose, title, children }: DrawerProps) => {
  ...
  return (
    <div className="fixed top-20 lg:top-24 right-0 h-[calc(100vh-4rem)] lg:w-[95%] w-full bg-white shadow-xl z-50 animate-slide-in transition-transform duration-300 rounded-md">
