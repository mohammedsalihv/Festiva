...
export const AssetsCard: React.FC<AssetsCardProps> = ({
  ...
  return (
    <div className="relative w-full max-w-[220px] sm:max-w-[240px] md:max-w-[260px] aspect-[3/4] rounded-xl overflow-hidden shadow bg-white">
      {/* Background Image */}
      <img
        src={imageSrc}
        alt="Card"
      ...
      {/* Overlay */}
      <div className="relative z-10 flex flex-col justify-between h-full p-3 bg-black/30 text-white">
        {/* Header */}
