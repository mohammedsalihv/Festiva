...
import { removeImage } from '@/redux/Slice/host/imageSlice';
  ...
  return (
    ...
    <div className="flex flex-col md:flex-row justify-between items-start gap-6 p-8 bg-white max-w-6xl mx-auto mt-10">
      <div className="w-full md:w-1/2 px-4">
        <h2 className="text-xl font-semibold mb-4 font-prompt">Get your listing to stand out</h2>
        <p className="text-red-500 bg-red-100 px-3 py-1 rounded mb-2 text-sm inline-block">
          You need at least 1 photo. You can skip for now, but won’t be able to publish the listing.
        </p>
        <p className="text-gray-600 mb-4 text-sm font-JosephicSans">
          Add as many images of your location as you'd like. Photographers typically select a location based on the photos. This helps them tremendously. Make sure your images are at least 1020px wide. Horizontal images work best.
        </p>
        <div
        ...
        >
          <p className="text-sm text-gray-500">
            Drag and drop or <span className="text-indigo-600 font-medium">click to upload your photos</span>
          </p>
          <p className="text-xs text-gray-400 mt-1 font-JosephicSans">Add as many images of your location as you'd like (at least 1)</p>
          <input
            type="file"
            ref={fileInputRef}
      ...
      <div className="w-full md:w-1/2 bg-gray-50 border border-gray-200 rounded-lg px-8 py-5 mt-6 md:mt-8 hidden md:block">
        <img src={Images.image_uplaod} alt="Photographer Illustration" className="mb-4 mx-auto h-24" />
        ...
        <p className="text-gray-600 text-sm mb-4 font-JosephicSans">
          Include photos of the areas that will be available: interior and exterior.
        </p>
